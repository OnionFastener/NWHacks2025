...
enum llama_ftype {
  ...
  // LLAMA_FTYPE_MOSTLY_Q4_0_4_4      = 33, // removed from gguf files, use Q4_0
  // and runtime repack LLAMA_FTYPE_MOSTLY_Q4_0_4_8      = 34, // removed from
  // gguf files, use Q4_0 and runtime repack LLAMA_FTYPE_MOSTLY_Q4_0_8_8      =
...
// TODO: simplify
// (https://github.com/ggerganov/llama.cpp/pull/9294#pullrequestreview-2286561979)
...
typedef struct llama_token_data_array {
  ...
  size_t size;
  int64_t
      selected; // this is the index in the data array (i.e. not the token id)
  bool sorted;
...
// (https://github.com/ggerganov/llama.cpp/discussions/9172)
LLAMA_API struct llama_model_params llama_model_default_params(void);
LLAMA_API struct llama_context_params llama_context_default_params(void);
LLAMA_API struct llama_sampler_chain_params
...
LLAMA_API llama_token
llama_token_eot(const struct llama_model *model); // end-of-turn
LLAMA_API llama_token
...
DEPRECATED(LLAMA_API llama_token
               llama_token_prefix(const struct llama_model *model),
           "use llama_token_fim_pre instead");
DEPRECATED(LLAMA_API llama_token
               llama_token_middle(const struct llama_model *model),
           "use llama_token_fim_mid instead");
DEPRECATED(LLAMA_API llama_token
               llama_token_suffix(const struct llama_model *model),
...
// TODO: in the future, the entire sampling API that uses llama_model should
// start using llama_vocab
//
...
llama_sampler_clone(const struct llama_sampler *smpl);
...
LLAMA_API struct llama_sampler *
llama_sampler_chain_remove(struct llama_sampler *chain, int32_t i);
...
DEPRECATED(
    ...
    "https://github.com/ggerganov/llama.cpp/pull/9896#discussion_r1800920915)");
...
LLAMA_API struct llama_sampler *
llama_sampler_init_mirostat(int32_t n_vocab, uint32_t seed, float tau,
                            float eta, int32_t m);
...
LLAMA_API struct llama_sampler *
llama_sampler_init_grammar(const struct llama_model *model,
...
LLAMA_API struct llama_sampler *
llama_sampler_init_dry(const struct llama_model *model, float dry_multiplier,
                       float dry_base, int32_t dry_allowed_length,
                       int32_t dry_penalty_last_n, const char **seq_breakers,
                       size_t num_breakers);

LLAMA_API struct llama_sampler *
llama_sampler_init_logit_bias(int32_t n_vocab, int32_t n_logit_bias,
...
//
LLAMA_API struct llama_sampler *
llama_sampler_init_infill(const struct llama_model *model);
...
LLAMA_API struct llama_perf_context_data
llama_perf_context(const struct llama_context *ctx);
LLAMA_API void llama_perf_context_print(const struct llama_context *ctx);
LLAMA_API void llama_perf_context_reset(struct llama_context *ctx);

// NOTE: the following work only with samplers constructed via
// llama_sampler_chain_init
LLAMA_API struct llama_perf_sampler_data
llama_perf_sampler(const struct llama_sampler *chain);
